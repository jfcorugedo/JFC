...
import com.myhome.controller.AttributeController;
...
privileged aspect AttributeController_Roo_Controller {
    ...
    @Autowired
    AttributeService AttributeController.attributeService;
    
    @Autowired
    CardService AttributeController.cardService;
    ...
    public String AttributeController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("attribute", attributeService.findAttribute(id));
    ...
    public String AttributeController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("attributes", attributeService.findAttributeEntries(firstResult, sizeNo));
            float nrOfPages = (float) attributeService.countAllAttributes() / sizeNo;
    ...
    public String AttributeController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, attributeService.findAttribute(id));
        return "attributes/update";
    }
