...
privileged aspect AttributeDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    CardDataOnDemand AttributeDataOnDemand.cardDataOnDemand;
    
    @Autowired
    AttributeService AttributeDataOnDemand.attributeService;
    ...
    public void AttributeDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = attributeService.findAttributeEntries(from, to);
        if (data == null) {
